...
const ALL_BADGES = [
  ...
  { id: 'world_ready', icon: '🌐', label: 'World Ready', desc: 'Completed all 8 regions', check: h => new Set(h.map(s => s.region)).size >= Object.keys(REGIONS).length },
  ...
  { id: 'veteran', icon: '🏆', label: 'Veteran', desc: 'Completed 10 interviews', check: h => h.length >= 10 },
];
